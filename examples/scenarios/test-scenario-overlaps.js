#!/usr/bin/env node
/**
 * Script to systematically test all scenarios for overlaps
 * This will be used with browser automation
 */
...
console.log('Scenarios to test:', scenarios.length);
console.log('Test each scenario at: http://localhost:8080/examples/scenarios/{scenario}.html');
console.log('\nUse this JavaScript in browser console to check overlaps:');
console.log(`
